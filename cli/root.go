...
func Execute() {
	...
	imluckyCmd.Flags().BoolVarP(&luckySkipSSHConfiguration, "skip-ssh", "s", false, "Use this option when ClusterUser already exists and SSH access is configured on nodes being added")
